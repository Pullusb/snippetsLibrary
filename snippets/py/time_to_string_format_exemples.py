...
%%a: %a  - Locale abbreviated weekday name.
%%A: %A  - Locale full weekday name.
%%b: %b  - Locale abbreviated month name.
%%B: %B  - Locale full month name.
%%c: %c  - Locale appropriate date and time representation.
...
%%p: %p  - Locale equivalent of either AM or PM.
...
%%x: %x  - Locale appropriate date representation.
%%X: %X  - Locale appropriate time representation.
