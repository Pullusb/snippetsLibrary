## Original Blender location <> region conversion. from source_code/scripts/modules/bpy_extras/view3d_utils.py" (here from blender 4.5)
## To use as reference or to tweak for a specific usage

## Called natively in blender like this
